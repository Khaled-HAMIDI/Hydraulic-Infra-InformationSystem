...
public class GetNbOuvrageController {
    private final GetNbOuvrages getNbOuvrages;
    @GetMapping(value = "/ouvrage/nb")
    ...
    List<Object> getNbouvrages(){
        return getNbOuvrages.getNbOuvrages();
    }
}
