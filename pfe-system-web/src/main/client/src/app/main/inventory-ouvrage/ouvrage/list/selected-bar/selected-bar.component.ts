...
import { OuvrageListService } from '../ouvrage-list/ouvrage-list.service';
...
export class OuvragesSelectedBarComponent implements OnInit, OnDestroy
{
    ...
    constructor(private ouvrageListService: OuvrageListService, public _matDialog: MatDialog, private toolsService: ToolsService)
    {
