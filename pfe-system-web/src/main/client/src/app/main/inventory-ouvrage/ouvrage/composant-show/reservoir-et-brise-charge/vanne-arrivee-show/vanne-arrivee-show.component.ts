...
@Component({
  selector: 'app-vanne-arrivee-show',
  templateUrl: './vanne-arrivee-show.component.html',
  styleUrls: ['./vanne-arrivee-show.component.scss'],
    animations: fuseAnimations
})
export class VanneArriveeShowComponent implements OnInit {
    ...
    typeEquipement(composants):EquipementHydroMeca{
        for (var i in composants){
            if (composants[i].equipementType =='VanneArrivee') return composants[i];
        }
        return null;
    }
