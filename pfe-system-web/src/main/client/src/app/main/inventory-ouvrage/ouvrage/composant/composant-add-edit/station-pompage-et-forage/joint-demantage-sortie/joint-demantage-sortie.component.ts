...
@Component({
  selector: 'app-joint-demantage-sortie',
  templateUrl: './joint-demantage-sortie.component.html',
  styleUrls: ['./joint-demantage-sortie.component.scss'],
    animations: fuseAnimations
})
export class JointDemantageSortieComponent implements OnInit{
    ...
    createForm(composant): FormGroup {
        let obj = {
            ...
            equipementType:['JointDemantageSortie'],
    ...
    typeEquipement(composants):EquipementHydroMeca{
        for (var i in composants){
            if (composants[i].equipementType =='JointDemantageSortie') return composants[i];
        }
        return null;
    }
