...
@Component({
  selector: 'app-clapet-anti-retour-show',
  templateUrl: './clapet-anti-retour-show.component.html',
  styleUrls: ['./clapet-anti-retour-show.component.scss'],
    animations: fuseAnimations
})
export class ClapetAntiRetourShowComponent implements OnInit {
