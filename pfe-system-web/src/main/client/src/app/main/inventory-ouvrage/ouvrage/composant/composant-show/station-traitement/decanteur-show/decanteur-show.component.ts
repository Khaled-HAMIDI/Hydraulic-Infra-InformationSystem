...
@Component({
  selector: 'app-decanteur-show',
  templateUrl: './decanteur-show.component.html',
  styleUrls: ['./decanteur-show.component.scss'],
    animations: fuseAnimations
})
export class DecanteurShowComponent implements OnInit {
