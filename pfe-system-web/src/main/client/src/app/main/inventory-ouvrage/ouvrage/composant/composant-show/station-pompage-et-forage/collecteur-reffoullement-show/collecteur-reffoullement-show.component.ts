...
@Component({
  selector: 'app-collecteur-reffoullement-show',
  templateUrl: './collecteur-reffoullement-show.component.html',
  styleUrls: ['./collecteur-reffoullement-show.component.scss'],
    animations: fuseAnimations
})
export class CollecteurReffoullementShowComponent implements OnInit {
