...
@Component({
  selector: 'app-obturateur',
  templateUrl: './obturateur.component.html',
  styleUrls: ['./obturateur.component.scss'],
    animations: fuseAnimations
})
export class ObturateurComponent implements OnInit{
