...
@Component({
  selector: 'app-clapet-anti-retour',
  templateUrl: './clapet-anti-retour.component.html',
  styleUrls: ['./clapet-anti-retour.component.scss'],
    animations: fuseAnimations
})
export class ClapetAntiRetourComponent implements OnInit{
    ...
    createForm(composant): FormGroup {
        let obj = {
            ...
            equipementType:['ClapetAntiRetour'],
