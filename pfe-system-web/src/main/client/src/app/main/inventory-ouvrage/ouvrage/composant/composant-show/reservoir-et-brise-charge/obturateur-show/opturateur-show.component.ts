...
@Component({
  selector: 'app-opturateur-show',
  templateUrl: './opturateur-show.component.html',
  styleUrls: ['./opturateur-show.component.scss'],
    animations: fuseAnimations
})
export class OpturateurShowComponent implements OnInit {
