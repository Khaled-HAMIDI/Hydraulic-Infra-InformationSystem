...
export class ComposantAerationComponent implements OnInit{
    ...
    createForm(composant): FormGroup {
        let obj = {
            ...
            typeEquipement:['ComposantAeration'],
    ...
    initForm(action){
        if (action == 'edit') {
            ...
            if(this.typeEquipement(this.equipements)) {
                ...
                this.composantAerationForm = this.createForm(this.equipement);
            }
    ...
    typeEquipement(composants):EquipementStationTraitement{
        for (var i in composants){
            if (composants[i].typeEquipement =='ComposantAeration') return composants[i];
        }
        return null;
    }
