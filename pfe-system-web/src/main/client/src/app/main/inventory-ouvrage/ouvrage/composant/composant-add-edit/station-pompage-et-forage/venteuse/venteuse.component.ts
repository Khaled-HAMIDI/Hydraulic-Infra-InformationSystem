...
@Component({
  selector: 'app-venteuse',
  templateUrl: './venteuse.component.html',
  styleUrls: ['./venteuse.component.scss'],
    animations: fuseAnimations
})
export class VenteuseComponent implements OnInit{
