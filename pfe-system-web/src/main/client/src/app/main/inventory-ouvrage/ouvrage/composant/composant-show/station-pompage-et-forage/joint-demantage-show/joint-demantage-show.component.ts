...
@Component({
  selector: 'app-joint-demantage-show',
  templateUrl: './joint-demantage-show.component.html',
  styleUrls: ['./joint-demantage-show.component.scss'],
    animations: fuseAnimations
})
export class JointDemantageShowComponent implements OnInit {
