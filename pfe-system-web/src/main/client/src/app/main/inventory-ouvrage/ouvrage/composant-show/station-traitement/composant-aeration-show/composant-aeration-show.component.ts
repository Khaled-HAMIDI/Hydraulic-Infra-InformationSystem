...
@Component({
  selector: 'app-composant-aeration-show',
  templateUrl: './composant-aeration-show.component.html',
  styleUrls: ['./composant-aeration-show.component.scss'],
    animations: fuseAnimations
})
export class ComposantAerationShowComponent implements OnInit {
    ...
    typeEquipement(composants):EquipementStationTraitement{
        for (var i in composants){
            if (composants[i].typeEquipement =='ComposantAération') return composants[i];
        }
        return null;
    }
