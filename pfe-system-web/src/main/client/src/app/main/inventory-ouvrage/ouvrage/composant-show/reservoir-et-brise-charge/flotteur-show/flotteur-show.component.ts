...
@Component({
  selector: 'app-flotteur-show',
  templateUrl: './flotteur-show.component.html',
  styleUrls: ['./flotteur-show.component.scss'],
    animations: fuseAnimations
})
export class FlotteurShowComponent implements OnInit {
