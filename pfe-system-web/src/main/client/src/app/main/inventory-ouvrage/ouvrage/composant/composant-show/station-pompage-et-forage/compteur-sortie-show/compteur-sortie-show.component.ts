...
@Component({
  selector: 'app-compteur-sortie-show',
  templateUrl: './compteur-sortie-show.component.html',
  styleUrls: ['./compteur-sortie-show.component.scss'],
    animations: fuseAnimations
})
export class CompteurSortieShowComponent implements OnInit {
