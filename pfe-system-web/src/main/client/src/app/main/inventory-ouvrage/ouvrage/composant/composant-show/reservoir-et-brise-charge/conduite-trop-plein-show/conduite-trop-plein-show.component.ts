...
@Component({
  selector: 'app-conduite-trop-plein-show',
  templateUrl: './conduite-trop-plein-show.component.html',
  styleUrls: ['./conduite-trop-plein-show.component.scss'],
    animations: fuseAnimations
})
export class ConduiteTropPleinShowComponent implements OnInit {
