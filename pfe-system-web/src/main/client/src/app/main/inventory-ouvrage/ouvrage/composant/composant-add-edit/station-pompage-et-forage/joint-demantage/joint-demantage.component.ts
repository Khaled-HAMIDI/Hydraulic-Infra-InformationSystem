...
@Component({
  selector: 'app-joint-demantage',
  templateUrl: './joint-demantage.component.html',
  styleUrls: ['./joint-demantage.component.scss'],
    animations: fuseAnimations
})
export class JointDemantageComponent implements OnInit{
    ...
    typeEquipement(composants):EquipementHydroMeca{
        for (var i in composants){
            if (composants[i].equipementType =='JointDemantage') return composants[i];
        }
        return null;
    }
