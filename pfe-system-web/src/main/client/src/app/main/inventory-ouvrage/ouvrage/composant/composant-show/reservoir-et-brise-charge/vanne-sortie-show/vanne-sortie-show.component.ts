...
@Component({
  selector: 'app-vanne-sortie-show',
  templateUrl: './vanne-sortie-show.component.html',
  styleUrls: ['./vanne-sortie-show.component.scss'],
    animations: fuseAnimations
})
export class VanneSortieShowComponent implements OnInit {
