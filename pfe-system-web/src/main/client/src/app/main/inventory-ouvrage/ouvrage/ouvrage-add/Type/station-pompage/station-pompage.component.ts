...
import {StationPompageService} from "./station-pompage.service";
...
export class StationPompageComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private stationPompageService: StationPompageService,
    ...
    onSave(): void {
        ...
        this.ouvrageAdd.waterTank = ouvrage.waterTank;
        this.ouvrageAdd.tankCapacity2 = ouvrage.tankCapacity2;
