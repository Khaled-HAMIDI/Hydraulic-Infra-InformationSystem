...
@Component({
  selector: 'app-vanne-pompage-show',
  templateUrl: './vanne-pompage-show.component.html',
  styleUrls: ['./vanne-pompage-show.component.scss'],
    animations: fuseAnimations
})
export class VannePompageShowComponent implements OnInit {
