...
@Component({
  selector: 'app-conduite-vidange',
  templateUrl: './conduite-vidange.component.html',
  styleUrls: ['./conduite-vidange.component.scss'],
    animations: fuseAnimations
})
export class ConduiteVidangeComponent implements OnInit{
    ...
    createForm(composant): FormGroup {
        let obj = {
            ...
            equipementType:['ConduiteVidange'],
