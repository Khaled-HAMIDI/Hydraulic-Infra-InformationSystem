...
import { OuvrageDeclassedListService } from './ouvrage-declassed/ouvrage-list/ouvrage-list.service';
import { OuvrageDeclassedListComponent } from './ouvrage-declassed/ouvrage-list/ouvrage-list.component';
import { OuvragesDeclassedSelectedBarComponent } from './ouvrage-declassed/selected-bar/selected-bar.component';
...
const routes: Routes = [
    ...
    {
        path: 'add/Station de Traitement Conventionelle/:id/:code',
