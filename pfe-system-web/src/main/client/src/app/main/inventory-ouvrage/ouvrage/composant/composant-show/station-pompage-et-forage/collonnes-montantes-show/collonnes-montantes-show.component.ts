...
@Component({
  selector: 'app-collonnes-montantes-show',
  templateUrl: './collonnes-montantes-show.component.html',
  styleUrls: ['./collonnes-montantes-show.component.scss'],
    animations: fuseAnimations
})
export class CollonnesMontantesShowComponent implements OnInit {
    ...
    typeEquipement(composants):EquipementHydroMeca{
        for (var i in composants){
            if (composants[i].equipementType =='CollenesMontantes') return composants[i];
        }
        return null;
    }
