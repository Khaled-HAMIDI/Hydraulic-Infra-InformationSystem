...
@Component({
  selector: 'app-joint-demantage-sortie-show',
  templateUrl: './joint-demantage-sortie-show.component.html',
  styleUrls: ['./joint-demantage-sortie-show.component.scss'],
    animations: fuseAnimations
})
export class JointDemantageSortieShowComponent implements OnInit {
