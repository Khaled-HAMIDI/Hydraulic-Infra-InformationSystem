...
@Component({
  ...
  templateUrl: './vanne-pompage.component.html',
  styleUrls: ['./vanne-pompage.component.scss'],
    animations: fuseAnimations
})
export class VannePompageComponent implements OnInit{
    ...
    initForm(action){
        if (action == 'edit') {
            ...
            if(this.typeEquipement(this.equipements)) {
                ...
                this.vannePompageForm = this.createForm(this.equipement);
            }
