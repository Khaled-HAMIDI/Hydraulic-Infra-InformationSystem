...
@Component({
  selector: 'app-compteur-sortie',
  templateUrl: './compteur-sortie.component.html',
  styleUrls: ['./compteur-sortie.component.scss'],
    animations: fuseAnimations
})
export class CompteurSortieComponent implements OnInit{
    ...
    createForm(composant): FormGroup {
        let obj = {
            ...
            equipementType:['CompteurDebimetreSortie'],
    ...
    typeEquipement(composants):EquipementHydroMeca{
        for (var i in composants){
            if (composants[i].equipementType =='CompteurDebimetreSortie') return composants[i];
        }
        return null;
    }
