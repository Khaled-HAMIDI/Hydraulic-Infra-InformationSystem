...
@Component({
  selector: 'app-collecteur-aspiration',
  templateUrl: './collecteur-aspiration.component.html',
  styleUrls: ['./collecteur-aspiration.component.scss'],
    animations: fuseAnimations
})
export class CollecteurAspirationComponent implements OnInit{
    ...
    createForm(composant): FormGroup {
        let obj = {
            ...
            equipementType:['CollecteurAspiration'],
