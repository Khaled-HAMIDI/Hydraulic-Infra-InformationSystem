...
@Component({
  selector: 'app-compteur-show',
  templateUrl: './compteur-show.component.html',
  styleUrls: ['./compteur-show.component.scss'],
    animations: fuseAnimations
})
export class CompteurShowComponent implements OnInit {
    ...
    typeEquipement(composants):EquipementHydroMeca{
        for (var i in composants){
            if (composants[i].equipementType =='CompteurDebimetre') return composants[i];
        }
        return null;
    }
