...
public abstract class GenericSpecificationsBuilder<U> {

    protected final List<SpecSearchCriteria> params;
    ...
    public final GenericSpecificationsBuilder<U> with(final String precedenceIndicator,
                                                      final String key, final String operation,
                                                      final Object value, final String prefix,
                                                      final String suffix) {
    ...
    public abstract Specification<U> build();
